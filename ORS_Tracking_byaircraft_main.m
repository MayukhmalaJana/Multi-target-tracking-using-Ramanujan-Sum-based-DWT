...
%----------------------------------------------------------------------
clear all;
%% Read the video file (choose your own file)
v=VideoReader("Aircraft tracking.mp4");
%% The ground truth of the video frame that needs to be segmented (uncomment before use and replace the filename with your file)
